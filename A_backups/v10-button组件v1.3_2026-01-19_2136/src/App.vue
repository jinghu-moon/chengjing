...
<template>
  <div class="app-wrapper">
    ...
    <div v-if="true" class="debug-toast-panel">
      ...
      <!-- Button Gallery -->
      <div class="debug-separator"></div>
      <div class="debug-subtitle">Button 组件</div>

      <!-- 按钮类型 (Theme & Variant) -->
      <div class="debug-row" style="flex-wrap: wrap">
        <Button theme="primary" effect="sweep">Sweep Effect</Button>
        <Button theme="primary" effect="ripple">Ripple (Default)</Button>
        <Button theme="primary" effect="none">No Effect</Button>
      ...
      <div class="debug-row" style="flex-wrap: wrap">
        ...
        <Button theme="default" :icon="IconEdit">编辑</Button>
        <Button variant="outline" theme="danger" :icon="IconTrash">删除</Button>
        <Button :icon="IconSearch" shape="circle" />
        <Button :icon="IconEdit" shape="circle" theme="default" />
        <Button :icon="IconPlus" shape="circle" theme="primary" size="large" />
      </div>

      <!-- 按钮形状 -->
      <div class="debug-row" style="flex-wrap: wrap">
        <Button theme="primary" shape="square" :icon="IconSearch"></Button>
        <Button theme="primary" shape="round">Round</Button>
        <Button theme="primary" :icon="IconSearch" shape="circle" />
      </div>

      <!-- 按钮状态 -->
      <div class="debug-row" style="flex-wrap: wrap">
        <Button theme="primary" :loading="true">Loading</Button>
        <Button theme="default" :disabled="true">Disabled</Button>
      ...
      <!-- Split Button -->
      <div class="debug-row" style="flex-wrap: wrap">
        <ButtonGroup split theme="primary">
          <Button :icon="IconDeviceFloppy">保存</Button>
          <Button :icon="IconSearch" shape="square" />
        </ButtonGroup>
        <ButtonGroup split theme="danger">
          <Button>删除</Button>
          <Button :icon="IconTrash" shape="square" />
        </ButtonGroup>
      </div>

      <!-- 图标在文本后面 -->
      <div class="debug-row" style="flex-wrap: wrap">
        <Button theme="primary" :suffix="IconSearch">搜索</Button>
        <Button theme="default" :suffix="IconEdit">编辑</Button>
        <Button variant="outline" :suffix="IconTrash">删除</Button>
      </div>
    </div>
  </div>
</template>
