    ...
    <div class="demo-grid">
      ...
      <section class="demo-section">
        ...
        <div class="demo-group">
          <h3>Lift (悬浮升起)</h3>
          <div class="demo-row">
            <Button theme="primary" effect="lift">Lift Effect</Button>
            <Button theme="success" effect="lift" :icon="IconDeviceFloppy">保存</Button>
          </div>
        </div>
        <div class="demo-group">
          <h3>Sheen (流光)</h3>
          <div class="demo-row">
            <Button theme="primary" effect="sheen">Sheen Effect</Button>
            <Button theme="warning" effect="sheen">付费升级</Button>
          </div>
        </div>
        <div class="demo-group">
      ...
      <section class="demo-section">
        ...
        <div class="demo-group">
          ...
          <div class="demo-row">
            ...
            <Button theme="danger" effect="pulse">重要操作</Button>
          </div>
        </div>
        <div class="demo-group">
          <h3>Sweep (斜向填充)</h3>
        ...
        <div class="demo-group">
          ...
          <div class="demo-row">
            ...
            <Button theme="warning" effect="shake">错误提示</Button>
          </div>
        </div>
        <div class="demo-group">
          <h3>Progress (进度条)</h3>
          <div class="demo-row">
            <Button theme="primary" effect="progress">Progress</Button>
            <Button theme="success" effect="progress">提交表单</Button>
          </div>
        </div>
      </section>
      ...
      <section class="demo-section">
        ...
        <table class="guide-table">
          ...
          <tbody>
            <tr><td><code>lift</code></td><td>Hover</td><td>卡片/CTA</td><td>悬浮升起</td></tr>
            <tr><td><code>sheen</code></td><td>Hover</td><td>付费/高级</td><td>流光吸引</td></tr>
            <tr><td><code>icon-slide</code></td><td>Hover</td><td>导航/引导</td><td>图标滑入</td></tr>
            <tr><td><code>scale</code></td><td>Active</td><td>通用</td><td>物理按压</td></tr>
            <tr><td><code>ripple</code></td><td>Click</td><td>Material风格</td><td>水波纹</td></tr>
            <tr><td><code>pulse</code></td><td>Click</td><td>重要操作</td><td>光环扩散</td></tr>
            <tr><td><code>sweep</code></td><td>Click</td><td>确认操作</td><td>斜向填充</td></tr>
            <tr><td><code>shake</code></td><td>Click</td><td>错误/警告</td><td>否定抖动</td></tr>
            <tr><td><code>progress</code></td><td>Click</td><td>表单提交</td><td>进度反馈</td></tr>
          </tbody>
        </table>
      </section>
    </div>
